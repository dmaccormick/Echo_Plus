...
{
    // Currently only fully works with perspective cameras
    // TODO: Add full support for ortho cameras!
    ...
    public class RecTrack_Camera : MonoBehaviour, IRecordable
    {
        ...
        {
            // If any of the camera settings have changed, update the values and record the change
